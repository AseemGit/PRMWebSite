...
namespace PRMWebSite.Controllers
{
    public class BuildingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BuildingId,ManagerId,Name,Address")] Building building)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BuildingId,ManagerId,Name,Address")] Building building)
        {
            if (ModelState.IsValid)
            {
