...
namespace PRMWebSite.Controllers
{
    public class ApartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ApartmentId,BuildingId,Number,Rent,Availability,Size")] Apartment apartment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ApartmentId,BuildingId,Number,Rent,Availability,Size")] Apartment apartment)
        {
            if (ModelState.IsValid)
            {
