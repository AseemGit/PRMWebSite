...
namespace PRMWebSite.Controllers
{
    public class PropertyManagersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ManagerId,FirstName,LastName,Email,Password")] PropertyManager propertyManager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ManagerId,FirstName,LastName,Email,Password")] PropertyManager propertyManager)
        {
            if (ModelState.IsValid)
            {
